                            ...
                            swapOffer.tokenAddress != '' ? <>
                                ...
                                </div>
                                {
                                    swapOffer.amount > 0 ? <>
                                        ...
                                        <Button disableRipple startIcon={<img src={TezLogo} className="eth-img" />} sx={{ height: "30px", padding: "10px 15px !important" }} className={"btn bg-white primary-border b-grey-text font-12"} variant="outlined">{`${swapOffer.amount} XTZ`}</Button></> : null
                                }
                            </> : null
                        }
                        {
                            reserveOffer.deposit > 0 ? <>
                                <Button disableRipple startIcon={<img src={TezLogo} className="eth-img" />} sx={{ height: "30px", padding: "10px 15px !important" }} className={"btn bg-white primary-border b-grey-text font-12"} variant="outlined">{`${reserveOffer.deposit} XTZ`}</Button>
                                <span className='t2-text font-bold-20'>+</span>
                                <Button disableRipple startIcon={<img src={TezLogo} className="eth-img" />} sx={{ height: "30px", padding: "10px 15px !important" }} className={"btn bg-white primary-border b-grey-text font-12"} variant="outlined">{`${reserveOffer.remainingAmount} XTZ`}</Button>
                                <span className='t2-text font-bold-20'>{`${reserveOffer.duration} Days`}</span>
                            </> : null
                        }
                        {
                            swapNowOffer.amount > 0 ? <Button disableRipple startIcon={<img src={TezLogo} className="eth-img" />} sx={{ height: "30px", padding: "10px 15px !important" }} className={"btn bg-white primary-border b-grey-text font-12"} variant="outlined">{`${swapNowOffer.amount} XTZ`}</Button> : null
                        }
                    </div>
                </div>
            </div>
